...
instance Applicative List where
  ...
  (<*>) ::
    ...
    -> List a
    -> List b
  (<*>) listf lista = flatMap (\atob -> map atob lista) listf
  -- listf :: List (a -> b)
  -- lista :: List a
...
lift4 ::
  ...
  -> f d
  -> f e
lift4 func fa fb fc fd = lift3 func fa fb fc <*> fd
...
sequence (h :. tl) = lift2 (:.) h (sequence tl)
...
replicateA num fa = sequence (replicate num fa)
  -- num :: Int
  -- fa  :: f a
  -- ??  :: f (List a)
